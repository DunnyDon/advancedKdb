...
endofday:{end d;d+:1;if[l;hclose l;l::0(`.u.ld;d)];.utils.newLog[]};
ts:{if[.utils.check<>.utils.tmp:`second$.z.T;.utils.logD[]];;if[d<x;if[d<x-1;system"t 0";'"more than one day?"];endofday[]]};
